package nari.distribution.TopoAnalysis;

import nari.Dao.interfaces.DbAdaptor;
import nari.distribution.TopoAnalysis.service.DistributionTopoAnalysisService;
import nari.distribution.TopoAnalysis.service.impl.DistributionTopoAnalysisServiceImpl;
...
@ActivatorReg(name="DistributionTopoServiceActivator")
public class DistributionTopoServiceActivator implements Activator,TrackerListener{
	...
	public boolean start(BundleContext context) throws BundleException {
		...
		context.export(DistributionTopoAnalysisService.class, new Provider<DistributionTopoAnalysisService>() {

			@Override
			public DistributionTopoAnalysisService get() throws BundleException {
				return new DistributionTopoAnalysisServiceImpl();
			}

			@Override
			public AttributeKey getKey() throws BundleException {
				return AttributeKey.key(DistributionTopoAnalysisService.class, Version.defaultVersion());
			}
