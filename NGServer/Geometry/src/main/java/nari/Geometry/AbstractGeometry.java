...
public abstract class AbstractGeometry implements Geometry {
	...
	public boolean intersects(Geometry geom) {
		com.vividsolutions.jts.geom.Geometry target = getJtsGeometry(geom);
		com.vividsolutions.jts.geom.Geometry source = getJtsGeometry(this);
		return source.intersects(target);
	}

	private com.vividsolutions.jts.geom.Geometry getJtsGeometry(Geometry geom){
		...
		switch (type) {
			...
			case POLYGON:
				...
				break;
			case MULTIPOINT:
				AbstractGeometryCollection pointColl = (AbstractGeometryCollection)geom;
				...
				break;
			case MULTIPOLYLINE:
				AbstractGeometryCollection lineColl = (AbstractGeometryCollection)geom;
				...
				break;
			case MULTIPOLYGON:
				AbstractGeometryCollection polyColl = (AbstractGeometryCollection)geom;
