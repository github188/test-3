...
public class JdkCompiler extends AbstractCompiler {
    ...
    public JdkCompiler(){
        ...
        } else if(loader.getClass().getName().indexOf("ChangeAwareClassLoader")>=0){
        	try {
                List<File> files = new ArrayList<File>();
                Method m = null;
                try {
					m = loader.getClass().getMethod("getClassPath");
					if(m!=null){
						String path = (String)m.invoke(loader);
    ...
    public Class<?> doCompile(String name, String sourceCode) throws Throwable {
        ...
        for(Diagnostic<?> dia:diagnosticCollector.getDiagnostics()){
        	logger.info("code:"+dia.getCode()+","+"col:"+dia.getColumnNumber()+","+"start:"+dia.getStartPosition()+","+"end:"+dia.getEndPosition()+","+"msg:"+dia.getMessage(Locale.CHINESE)+","+"pos:"+dia.getPosition()+","+"source:"+dia.getSource()+","+"line:"+dia.getLineNumber());
        }
    ...
    private static final class JavaFileManagerImpl extends ForwardingJavaFileManager<JavaFileManager> {
        ...
        public Iterable<JavaFileObject> list(Location location, String packageName, Set<Kind> kinds, boolean recurse)
            ...
            e = contextClassLoader.getResources("nari");
            while (e.hasMoreElements()) {
                urlList.add(e.nextElement());
            }
